    ...
    <aside class="w-64 bg-white border-r border-gray-200 flex flex-col">
      ...
      <div class="p-4 border-t border-gray-100">
        <div class="flex items-center gap-3">
           <div class="w-8 h-8 rounded-full bg-blue-200 flex items-center justify-center text-white font-bold"> D </div>
           <div class="text-sm">
             <div class="font-medium text-gray-700">Diego Admin</div>
             <div class="text-gray-400 text-xs">diego@admin.com</div>
           </div>
        </div>
      </div>
    </aside>
