        ...
        <div class="bg-white rounded-xl shadow-2xl w-full max-w-2xl flex flex-col max-h-[90vh]">
            <div class="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50 rounded-t-xl">
                <div>
                    ...
                    <p class="text-sm text-gray-500">Administra los tipos de eventos y visualiza estadísticas.</p>
                </div>
                <button @click="$emit('close')" class="text-gray-400 hover:text-gray-600 p-1 hover:bg-gray-200 rounded-full transition">
                    <X />
                </button>
            </div>
